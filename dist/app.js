...
app.post('/api/v1/signup', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // const username = "iramsabak";
    // const password = "#Ir@msabak02".trim();
...
app.post('/api/v1/signin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: user._id, username: user.username }, config_1.default, { expiresIn: "1h" });
...
app.post('/api/v1/content', middleware_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield Schema_1.User.findOne({ username: "iramsabak" });
        ...
        const allowedtypes = ["image", "video", "article", "audio", "pdf", "text"];
...
app.post('/api/v1/brain/share', middleware_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // console.log(contentId,username);
    if (!contentId) {
    ...
    try {
        ...
        const contentExists = yield Schema_1.Content.find({ _id: { $in: contentId }, userId: user._id });
        if (!contentExists) {
...
app.get('/api/v1/brain/:sharedlink', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const sharedContent = yield Schema_1.myLink.findOne({ shareablelink: sharedlink });
        if (!sharedContent) {
